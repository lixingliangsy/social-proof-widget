 ...
 *
 * <script src="https://YOUR_DOMAIN/widget.js" data-host="https://YOUR_DOMAIN" data-product="social-proof-widget" async></script>
 *
...
(function () {
  ...
  host = host.replace(/\/+$/, "");
  var product = (tag && tag.getAttribute("data-product")) || "social-proof-widget";
  ...
  function build() {
    ...
    var panel = null;
    var sessionKey = (product || "social-proof-widget") + "_chat_session";
